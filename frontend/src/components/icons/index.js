// Reusable SVG Icon Library for Klozer — Zero Raw Emojis

export function QrIcon({ className = "w-5 h-5", ...props }) {
  return (
...
export function DollarSignIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function SparklesIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M19 2l1 2.5L22.5 5.5 20 6.5 19 9l-1-2.5-2.5-1 2.5-1z" />
    </svg>
  );
}
...
export function ClipboardListIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function HeadphonesIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export function KeyIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M21 2l-2 2m-1.5 1.5L14 9a5 5 0 1 0 4 4l5.5-5.5V5h-3.5v2.5H18V6h-1.5z" />
    </svg>
  );
}
...
export function BuildingIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <line x1="12" y1="22" x2="12" y2="12" /><line x1="9" y1="6" x2="9.01" y2="6" />
      <line x1="15" y1="6" x2="15.01" y2="6" /><line x1="9" y1="9" x2="9.01" y2="9" />
...
export function BanIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <circle cx="12" cy="12" r="10" />
...
export function WarehouseIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M3 20v-8l9-6 9 6v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
...
export function KlozerIcon({ className = "w-8 h-8", ...props }) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <defs>
        <linearGradient id="klozerBrandGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#0c1754" />
          <stop offset="100%" stopColor="#2545ff" />
        </linearGradient>
      </defs>
      <rect width="32" height="32" rx="7.5" fill="url(#klozerBrandGrad)" />
      <path d="M9 7.5 H13 V14.2 L18.8 7.5 H23.8 L16.4 15.6 L24.5 24.5 H19.2 L13 17.5 V24.5 H9 V7.5 Z" fill="#ffffff" />
      <circle cx="25.5" cy="7.5" r="2.5" fill="#38bdf8" />
    </svg>
  );
}
...
export function ReceiptIcon({ className = "w-5 h-5", ...props }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
