-- ============================================================================
-- KLOZER DATABASE SCHEMA - 17 CORE TABLES
-- Multi-Tenant AI Conversational Commerce & Smart CRM
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS `institutions` (
  ...
  `sector` VARCHAR(100) NULL DEFAULT 'Fashion & Retail',
  ...
  `features_json` JSON NULL, -- 14 feature module toggles
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `role` ENUM('superadmin', 'supervisor', 'owner', 'finance', 'cs', 'pic_warehouse') NOT NULL DEFAULT 'cs',
  `phone_number` VARCHAR(30) NULL,
  `commission_rate_percent` DECIMAL(5, 2) NOT NULL DEFAULT 5.00,
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `cost_price_hpp` DECIMAL(14, 2) NOT NULL DEFAULT 0.00,
...
-- 5. BANK ACCOUNTS & PAYMENT GATEWAY CONFIGS
...
CREATE TABLE IF NOT EXISTS `payment_gateway_configs` (
  ...
  `fee_charged_to_customer` TINYINT(1) NOT NULL DEFAULT 0,
  `is_active` TINYINT(1) NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `shipping_warehouses` (
  ...
  `couriers_active_json` JSON NULL,
...
CREATE TABLE IF NOT EXISTS `leads` (
  ...
  `risk_cod_score` TINYINT UNSIGNED NOT NULL DEFAULT 100,
...
-- 8. CHAT MESSAGES & PROACTIVE FOLLOW-UP JOBS
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `total_cost_hpp` DECIMAL(14, 2) NOT NULL DEFAULT 0.00,
...
-- 10. PAYMENTS, BANK MUTATIONS, & PAYMENT PROOFS
...
-- 12. META ADS & COMMISSION LEDGERS
